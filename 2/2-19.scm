...
; =============
;
; Consider the change-counting problem of Section 1.2.2. It would be nice to be
...
; would be nicer to be able to supply a list of coins to be used for making the
; change.
;
...
; No. We’re computing the total number of possible combinations, so we'll see
; all of them at some point anyway. It doesn't matter where we begin to count.
